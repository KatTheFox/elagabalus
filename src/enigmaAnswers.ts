...
export const enigmaAnswers = new Map<string, EnigmaDegrees>([
  ...
  ["fraser-strathcoyne-eryngium", EnigmaDegrees.FE6a],
  ["eryngium-rowena", EnigmaDegrees.FE7],
  ...
  ["christopher-strathcoyne-sea-holly", EnigmaDegrees.FE6],
  ["christopher-strathcoyne-eryngium", EnigmaDegrees.FE6a],
  ...
  ["fet-vak", EnigmaDegrees.KN4],
  ["vak-dagmar-von-nagelsburg", EnigmaDegrees.KN5],
  ["dagmar-von-nagelsburg-phalaenopsis", EnigmaDegrees.KN6],
  ["dagmar-von-nagelsburg-moth-orchid", EnigmaDegrees.KN6a],
  ["phalaenopsis-xenodice", EnigmaDegrees.KN7],
  ["moth-orchid-xenodice", EnigmaDegrees.KN7],
  ["xenodice-the-writing-on-the-wall", EnigmaDegrees.KN8],
  ["haustorium", EnigmaDegrees.MO1],
  ["lord-gristwood-sarcodes", EnigmaDegrees.MO6a],
  ["haustorium-skolekosophy", EnigmaDegrees.MO2],
  ["skolekosophy-shapt", EnigmaDegrees.MO3],
  ...
  ["sarcodes-robigo", EnigmaDegrees.MO7],
  ...
  ["yeshiva-tigris", EnigmaDegrees.SK1],
  ["yeshiva-tigris-preservation", EnigmaDegrees.SK2],
...
>([
  ...
  [EnigmaDegrees.MO2, "Skolekosophy"],
  ...
  [EnigmaDegrees.SK1, "Yeshiva Tigris"],
  ...
  [EnigmaDegrees.KN6a, "Moth Orchid"],
  [EnigmaDegrees.MO6a, "Sarcodes"],
]);
