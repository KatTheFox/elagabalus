...
enum EnigmaText {
  ...
  SC3 = "Sight, perception, inspiration, all the Glory's gifts.\n\n[One tongue, many eyes.]\n\nYou've achieved the third degree, 'element', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  SC4 = "In the Tracks of Beasts, in the Convolutions of his own Carapace, in Egg-vein and Shell-shadow, the Many-Eyed One found the Signs which can be History.\n\n[A visitor to the Labyrinth, torch-named, who can never return, only alight]\n\nYou've achieved the fourth degree, 'language', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  SC5 = "Fulgents are confined to the Mansus and the Bounds, but they have considerable influence there. They’re well-placed to shape and send dreams. Fulgents avoid the Wood. It’s confusing and unpleasant, and the Wood-names there will devour them if they can. There are risks in the House, too, from Mansus-names, but that’s manageable, and they have allies in the House…\n\n[Dapple and motley, shepherd-sung, swine-denying.]\n\nYou've achieved the fifth degree, 'visitor', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  SC6 = "Power-plucked from sacred soil where old blood was shed. Shadow, then snow.\n\n[The King of the World made his dedication to the Evening Star at the Gate of Gods. She lies long in the land of the Lionsmith’s Labyrinth.]\n\n\n\nYou've achieved the sixth degree, 'flower', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  SC7 = "“The Khusgai that we slew. On their standard they bore a silver hand. We took it as a trophy and it graces now the standard of my regiment. I still write that – I will not strike it out – but of course I cannot no longer claim that honour. It graces now the standard of the Poona Horse. If you ask to see it I think they will show it to you – if you use Malcolmson’s name and not mine. It is older than the regiment – as old I think as England. But no older. There is a lesson in it. Greatest among the powers who illuminate is one called Watchman. He it is who says ‘Mercy is found only in shadow.’ But he does not say that mercy is nowhere found; and shadows lie long at the Labyrinth of Lions.”\n\n[A sleeping gentleman and a solar majuscule.]\n\n\n\nYou've achieved the seventh degree, 'protectress', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  SC8 = "Beneath the Church of the Holy Belt in Emesa/Homs, there is, as legend relates, a secret room which was also the first church, consecrated (in 59) – perhaps as a Christian shrine by Paul the Apostle, perhaps as an Invictine shrine by Saul the Illuminated. There in a sarcophagus of black corundum lies Elagabalus, accursed of Janus, neither Long nor mortal, neither man nor woman, neither real nor imagined. On his light-suffused skin is made manifest the Sun-in-Splendour’s grand design… or a monstrous lie.\n\n[[Not until there are enough here. But look around.]]\n\nYou've achieved the eighth degree, 'wise', of the SC direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
  KN1 = "The Great Hooded Princes do not reveal their library’s location. Those few permitted entry will say only that it’s ‘west of the Lion, and north of Victory’. It contains knowledge on the ways and foundations of the Mansus; on the Fifth History, and above all on Knock lore. The Princes do not say ‘Knowledge is Power’, but rather, ‘Power is Knowledge.’ Relationships between the Princes and the Mother of Ants are strained, and the Tomb lies under the hand of the Horned Axe.\n\n[After this place, a suitable wisdom.]\n\n\n\nYou've achieved the first degree, 'library', of the KN direction of the Enigma of Secret Histories. You're entitled to use this badge wherever you like.",
}
